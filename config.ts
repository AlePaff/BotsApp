...
const config = {
    ...
    COUNTRY_CODE: process.env.COUNTRY_CODE === undefined ? "54" : process.env.COUNTRY_CODE,
    ...
    SUDO: process.env.SUDO === undefined ? "5491134017315,5491136666828,5491155852193" : process.env.SUDO,
